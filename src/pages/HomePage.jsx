...
const HomePage = ({ user, onNavigate, onLogout }) => {
  const labs = [
    { lab: 1, title: "Introduction to Web Services", titleAr: "مقدمة في خدمات الويب", icon: "🌐" },
    { lab: 2, title: "HTTP Protocol & Methods", titleAr: "بروتوكول HTTP والطرق", icon: "📡" },
    { lab: 3, title: "REST API Fundamentals", titleAr: "أساسيات REST API", icon: "🔗" },
    { lab: 4, title: "JSON Data Format", titleAr: "تنسيق بيانات JSON", icon: "📋" },
    { lab: 5, title: "API Authentication", titleAr: "مصادقة API", icon: "🔐" },
    { lab: 6, title: "Consuming REST APIs", titleAr: "استهلاك REST APIs", icon: "📥" },
    { lab: 7, title: "Building REST APIs", titleAr: "بناء REST APIs", icon: "🛠️" },
    { lab: 8, title: "SOAP Web Services", titleAr: "خدمات SOAP", icon: "📨" },
    { lab: 9, title: "API Testing & Documentation", titleAr: "اختبار وتوثيق API", icon: "📝" },
    { lab: 10, title: "Web Services Project", titleAr: "مشروع خدمات الويب", icon: "🚀" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900/30 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-teal-300/70 text-xs font-arabic">خدمات الويب</p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-teal-300/70 font-arabic">معامل الدورة</p>
        </div>
            ...
            return (
              <div key={lab.lab} onClick={() => onNavigate(`lab${lab.lab}`)} className={`p-5 rounded-xl border-2 cursor-pointer transition-all hover:scale-[1.02] ${isCompleted ? 'bg-emerald-900/20 border-emerald-500/50' : 'bg-slate-700/30 border-slate-600 hover:border-teal-500/50'}`}>
                <div className="flex items-start gap-3">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-xl ${isCompleted ? 'bg-emerald-600' : 'bg-teal-600'}`}>{isCompleted ? '✓' : lab.icon}</div>
                  <div className="flex-1">
                    <span className="text-xs text-teal-400 font-semibold">Lab {lab.lab} | المعمل {lab.lab}</span>
        ...
        <div className="mt-12 bg-slate-800/50 rounded-2xl p-8 border border-slate-700 text-center">
          ...
          <p className="text-teal-300/70 font-arabic mb-6">التواصل والدعم</p>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            ...
            <div>
              ...
              <p className="text-teal-300/70 font-arabic">سعد العمري</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <footer className="py-6 text-center border-t border-slate-800 mt-8">
        <p className="text-slate-500 text-sm">Web Services | Taif University | جامعة الطائف</p>
